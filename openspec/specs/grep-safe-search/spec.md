...
Safe, bounded read-only text search of a file or directory tree, literal or RE2 regex, that lets an agent detect misplaced private-key material by path/line without ever returning the key content.
