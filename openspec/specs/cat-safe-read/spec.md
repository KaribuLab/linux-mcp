...
Safe, bounded `cat` tool behavior: dual output caps, byte Seek resume, metadata + raw body response, binary/private-key blocking, and agent-facing MCP tool description.
